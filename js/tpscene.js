class TPScene extends BaseScene{
		...
		constructor(){
			...
			//Instantiate player
			this.createPlayer();
			this.setBackgroundImage("assets/Backgrounds/backgroundDesert.png");
			...
			this.configurePlayerCollisionHandler();
	
			
			//Create a way for player to interact with game
			InputHelper.ConfigureTPSceneKeyboardControls(this);
			

		}

		configurePlayerCollisionHandler(){
			...
			this.playerCollisionHandler = function(){
